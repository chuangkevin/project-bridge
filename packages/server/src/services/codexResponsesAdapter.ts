 ...
 * subscription).
 *
 * Ported from legacy v1.5 packages/server/src/services/codexResponsesAdapter.ts.
 * Import changes: none — file only imports from @kevinsisi/ai-core (external),
 * no local file imports required.
 */

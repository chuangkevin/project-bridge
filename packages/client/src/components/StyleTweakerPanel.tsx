...
const styles: Record<string, React.CSSProperties> = {
  container: { display: 'flex', flexDirection: 'column', height: '100%', overflow: 'hidden', backgroundColor: 'var(--bg-primary)' },
  scrollArea: { flex: 1, overflowY: 'auto', padding: '12px 16px', display: 'flex', flexDirection: 'column', gap: '10px' },
  row: { display: 'flex', alignItems: 'center', gap: '10px' },
  label: { fontSize: '12px', fontWeight: 500, color: 'var(--text-muted)', minWidth: '72px', flexShrink: 0, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' },
  control: { display: 'flex', alignItems: 'center', gap: '6px', flex: 1 },
  colorPicker: { width: '30px', height: '26px', border: '1px solid var(--border-primary)', borderRadius: '5px', padding: '2px', cursor: 'pointer', backgroundColor: 'var(--bg-input)', flexShrink: 0 },
  hexInput: { flex: 1, padding: '4px 7px', border: '1px solid var(--border-primary)', borderRadius: '5px', fontSize: '11px', outline: 'none', fontFamily: 'monospace', color: 'var(--text-primary)', backgroundColor: 'var(--bg-input)', minWidth: 0 },
  slider: { flex: 1, cursor: 'pointer', minWidth: 0 },
  sizeLabel: { fontSize: '11px', color: 'var(--text-secondary)', minWidth: '36px', textAlign: 'right', flexShrink: 0 },
  select: { flex: 1, padding: '4px 7px', border: '1px solid var(--border-primary)', borderRadius: '5px', fontSize: '12px', color: 'var(--text-primary)', backgroundColor: 'var(--bg-input)', outline: 'none' },
  footer: { padding: '12px 16px', borderTop: '1px solid var(--border-primary)', display: 'flex', flexDirection: 'column', gap: '6px', backgroundColor: 'var(--bg-elevated)' },
  hint: { margin: 0, fontSize: '11px', color: 'var(--text-muted)', textAlign: 'center' },
  saveBtn: { width: '100%', padding: '8px', background: 'linear-gradient(90deg, var(--accent-grad-start), var(--accent-grad-end))', color: '#ffffff', border: 'none', borderRadius: '7px', fontSize: '13px', fontWeight: 600, cursor: 'pointer', fontFamily: 'inherit' },
  emptyState: { display: 'flex', alignItems: 'center', justifyContent: 'center', height: '100%', padding: '24px', backgroundColor: 'var(--bg-primary)' },
  emptyText: { fontSize: '13px', color: 'var(--text-muted)', textAlign: 'center', lineHeight: '1.5' },
};

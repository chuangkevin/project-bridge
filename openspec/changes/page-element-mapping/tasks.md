...
- [x] 6.1 測試：進入頁面對應模式，驗證左側頁面總覽正確顯示
- [x] 6.2 測試：點選元素，設定導航目標，驗證 HTML onclick 更新
- [x] 6.3 測試：驗證架構圖同步（mapping 儲存後 ArchEdges 正確建立）
- [x] 6.4 測試：無架構圖的專案，驗證自動建立 ArchNodes
- [x] 6.5 測試：重新生成後，驗證 mapping 保留/清理邏輯
